...
#esptool.py write_flash 0x8000 /tmp/out/main.ino.partitions.bin
esptool.py --chip esp32 --port /dev/cuaU1 --baud 921600 write_flash -z --flash_mode dio --flash_freq 80m --flash_size 4MB 0x10000 $1
